...
public class CardGameStack {
    ...
    public static void main(String[] args) {
        ...
        n = sc.nextInt();
        CardGameStack s1 = new CardGameStack(n);
        CardGameStack s2 = new CardGameStack(n);
    ...
    public void game(CardGameStack s1, CardGameStack s2, int n, int maxSum) {
        int sum1 = 0, sum2 = 0;
        for (int i = n-1; i >= 0; i--) {
